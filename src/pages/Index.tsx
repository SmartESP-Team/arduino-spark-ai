  ...
  return <div className="min-h-screen bg-background overflow-hidden relative">
      ...
      <section className="container mx-auto px-4 py-24">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <FeatureCard emoji="🔌" title="Arduino IDE Integration" description="Works seamlessly with your existing Arduino IDE setup. No workflow disruption — just enhanced productivity." />
          <FeatureCard emoji="🧠" title="Intelligent Bug Detection" description="Instantly identifies syntax errors, logical issues, and optimization opportunities that save hours of debugging time." />
          <FeatureCard emoji="⚡" title="Real-Time Code Analysis" description="Get instant feedback as you code. Catch errors before compilation and understand issues immediately." />
          <FeatureCard emoji="📚" title="Expert-Level Explanations" description="Doesn't just fix — provides detailed explanations to deepen your understanding of Arduino programming concepts." />
          <FeatureCard emoji="🎯" title="Arduino-Specialized AI" description="Built specifically for Arduino by IOT4YOU2. Deep understanding of all Arduino libraries, functions, and hardware interactions." />
          <FeatureCard emoji="📈" title="Code Optimization Suggestions" description="Get recommendations to improve code efficiency, reduce memory usage, and enhance performance for production-ready projects." />
          <FeatureCard emoji="📋" title="Comprehensive Bug History" description="Track all detected issues and solutions. Learn from patterns and improve your coding skills over time." />
          <FeatureCard emoji="🔑" title="Flexible API Configuration" description="Use the included pre-configured API key or integrate your own Google Gemini key for unlimited, customized usage." />
          <FeatureCard emoji="🌐" title="Universal Compatibility" description="Helps everyone from hobbyists to professionals. Whether prototyping or building production systems, Arduino Assistant Coding scales with your needs." />
        </div>
      </section>
  ...
  <p><strong>2.</strong> Then click <button style="background-color: #007BFF; color: white; border: none; padding: 5px 10px; border-radius: 4px; cursor: pointer;">Analyze My Code</button> to save and process it.</p>
      ...
      <section className="container mx-auto px-4 py-24">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <TestimonialCard quote="As a professional IoT developer, this tool has cut my debugging time in half. The Arduino IDE integration is seamless and the AI explanations are spot-on." author="Alex M." role="IoT Solutions Architect" />
          <TestimonialCard quote="Game-changing for my engineering projects. It doesn't just fix errors — it teaches me better coding practices. My professors are impressed with my code quality now." author="Sarah K." role="Engineering Student" />
          <TestimonialCard quote="I've been coding Arduino for 5 years and wish I had this from day one. It catches issues I would have missed and optimizes my code automatically. Essential tool for any serious Arduino developer." author="Mike T." role="Robotics Engineer" />
        </div>
      </section>
      ...
      <Dialog open={showTesterDialog} onOpenChange={setShowTesterDialog}>
        <DialogContent className="bg-background border border-border shadow-xl">
          ...
          <div className="space-y-4 pt-4">
            <Input type="text" placeholder="TESTER-2025-XXX" value={testerId} onChange={e => setTesterId(e.target.value)} className="bg-background border-input focus-visible:ring-ring" onKeyDown={e => {
            if (e.key === "Enter") {
